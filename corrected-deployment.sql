-- =========================================================================
-- SoulLens.AI CORRECTED Database Schema
-- Production Deployment for mysoullens.com
-- Fixed execution order and column references
-- =========================================================================
...
-- Function to update program progress automatically
...
-- Function to check program access based on subscription
...
-- STEP 8: CREATE VIEWS (AFTER ALL TABLES AND FUNCTIONS EXIST)
-- =========================================================================
...
-- SELECT day_number, title FROM program_lessons WHERE program_id = (SELECT id FROM programs WHERE slug = 'into-confidence') ORDER BY day_number;